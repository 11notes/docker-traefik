...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/traefik:3.6.0 | 33MB | 1000:1000 | ✅ | amd64, arm64, armv7 |
| traefik:3.6.0 | 186MB | 0:0 | ❌ | amd64, arm64v8, armv6, ppc64le, riscv64, s390x |
...
* [3.6.0](https://hub.docker.com/r/11notes/traefik/tags?name=3.6.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/traefik:3.6.0
docker pull ghcr.io/11notes/traefik:3.6.0
docker pull quay.io/11notes/traefik:3.6.0
```
...
*created 10.11.2025, 09:05:32 (CET)*