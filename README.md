...
* [3.6.5](https://hub.docker.com/r/11notes/traefik/tags?name=3.6.5)
* [3.6.5-unraid](https://hub.docker.com/r/11notes/traefik/tags?name=3.6.5-unraid)
* [3.6.5-nobody](https://hub.docker.com/r/11notes/traefik/tags?name=3.6.5-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/traefik:3.6.5
docker pull ghcr.io/11notes/traefik:3.6.5
docker pull quay.io/11notes/traefik:3.6.5
```
...
*created 17.12.2025, 06:18:27 (CET)*