...
* [3.7.0](https://hub.docker.com/r/11notes/traefik/tags?name=3.7.0)
* [3.7.0-unraid](https://hub.docker.com/r/11notes/traefik/tags?name=3.7.0-unraid)
* [3.7.0-nobody](https://hub.docker.com/r/11notes/traefik/tags?name=3.7.0-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/traefik:3.7.0
docker pull ghcr.io/11notes/traefik:3.7.0
docker pull quay.io/11notes/traefik:3.7.0
```
...
*created 06.05.2026, 09:37:04 (CET)*